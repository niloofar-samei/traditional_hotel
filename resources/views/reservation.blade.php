	...
	<div class="container text-center" style="margin-top: 50px">
		<div style="margin: auto; width: 600px; background-image: linear-gradient(to right, #f46b45, #eea849); padding-top: 50px; padding-bottom: 20px; border-radius: 20px;">
			...
			<div style="border: 1px solid green" id="single-form">
				...
				<div class="form-group" style="padding: 10px;">
					<label style="padding-left: 15px;">{!! Form::radio('room_type', 'Single bed', true, ['id'=>'1']) !!} Single bed</label>
					<label style="padding-left: 15px;">{!! Form::radio('room_type', 'Twin bed', true, ['id'=>'2']) !!} Twin bed</label>
					<label style="padding-left: 15px;">{!! Form::radio('room_type', 'Three beds', true, ['id'=>'3']) !!} Three beds</label>
				</div>
